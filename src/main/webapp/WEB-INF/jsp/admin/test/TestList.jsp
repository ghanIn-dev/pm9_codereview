...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
		            <button type="button" class="btn btn-default pull-right" onclick="fn_moveToURL('adTestForm')">
            	...
            	<div class="panel-body">
					...
					<c:forEach var="listview" items="${listview}" varStatus="status">
						...
						<div class="listBody">
							...
							<div class="listHiddenField pull-left field100 textCenter"><c:out value="${listview.testcd}"/></div>
							<div class="listTitle" title="<c:out value="${listview.testnm}"/>">
								<a href="${link}"><c:out value="${listview.testnm}"/></a>
							</div>
						</div>
					</c:forEach>	
						...
						<div class="form-group">
							<div class="checkbox col-lg-3 pull-left">
							 	<label class="pull-right">
							 		<input type="checkbox" name="searchType" value="testnm" <c:if test="${fn:indexOf(searchVO.searchType, 'testnm')!=-1}">checked="checked"</c:if>/>
